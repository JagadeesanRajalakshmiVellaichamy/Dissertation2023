...
if __name__ == '__main__':
    ...
    end_date = '2019-04-10'
    # data = pd.read_csv("D:\\0_SHU_31018584\\Data\\Final_data\\youtube_apidata_47.csv", sep=',')
    data = FileReadFromDirectory("D:\\0_SHU_31018584\\Data\\Final_data\\", "youtube_apidata_*.csv")
    ...
    final.to_csv("D:\\0_SHU_31018584\\Data\\Youtube_Clean_dataframe.csv", index=False)
    ...
    mbert_lang_eva_metrics.to_csv("D:\\0_SHU_31018584\\Data\\NLP_mBERT_Metrics.csv", index=False)